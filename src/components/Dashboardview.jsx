  ...
  return (
    <div className='flex items-center justify-between h-[70px] shadow-lg px-[25px] '>
      <div className='flex items-center rounded-[5px]'>
        ...
        <div className='bg-[#4f73df] h-[40px] flex items-center cursor-pointer rounded-tr-[5px] rounded-br-[5px] '>
          ...
          <div className='flex items-center gap-[15px] relative'>
            ...
            <div className='flex items-center gap-[15px] relative' onClick={showDropDown}>
              <p>Douglas McGee</p>
              <div className='w-[50px] h-[50px] bg-[#4d73df] cursor-pointer flex items-center justify-center relative '>
                <img src={profile} alt='profile.png.webp' className='rounded-full' />
              </div>
