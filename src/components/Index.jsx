...
import chat from '../assets/chat-icon.webp'; 
        ...
        return (
          <div className='pt-[25px] px-[25px] bg-[#f8f9fc]'>
              ...
              <div className='grid grid-cols-4 gap-[30px] mt-[25px] pb-[15px]'>
                <div className='h-[100px] rounded-[8px] bg-white border-l-[4px] border-[#4e73df] flex items-center justify-between px-[30px] cursor-pointer hover-shadow-lg transform hover:scale-[10px] transition duration-300 ease'>
                  <div>
            ...
            <div className='basis-[30%] border bg-white shadow-md cursor-pointer rounded-[4px]'>
              ...
              <div className='bg-[#f8f9fc] flex item-center justify-between py-[15px] px-[20px] border-b-[1px]
              border-[#ededed]'>
              ...
              <div>
                  ...
                  <Progress percent={70} status="active" strokeColor="#4e730f" />
              </div>
              <div>
          ...
          <div className='basis-[45%] border bg-white shadow-md cursor-pointer rounded-[4px]'>
            <div  className='bg-[#f8f9fc] flex item-center justify-between py-[15px] px-[20px] border-b-[1px] border-[#ededed]'>
            ...
            <div className='pl-[35px] flex items-center justify-center h-[100%]'>
              <div>
                <img src={chat} alt='' className='w-[50px] h-[50px]' />
